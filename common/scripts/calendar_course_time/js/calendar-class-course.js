...
(function ($) {
  ...
  fn.initSettingWindow = function () {
    ...
    html += '       		<div class="bs-content form-group"><div class="row">';
    html += '           		<lable class="bs-lable control-label">日期范围</lable>';
    html += '           		<div class=" bs-options-wrapper">';
    html += '               		<input class="itext" name="startDay" placeholder="格式:年-月-日,例如:1970-01-01" type="text">';
    html += '               		<span class="white-space">-</span>';
    html += '               		<input class="itext" name="endDay" placeholder="格式:年-月-日,例如:1970-01-01" type="text">';
    html += '               	<label class="drw-enable"><input name="enableDateRange" type="checkbox"> 启用</label>';
    html += '           		</div>';
    html += '      			</div></div>';
    html += '       		<div class="bs-content bs-date-flexset">';
    html += '           		<lable class="bs-lable control-label">设置星期</lable>';
    html += '           		<div class="bs-options-wrapper">';
    ...
    html += '       	<button class="btn btn-primary">启用本设置</button>';
  ...
  fn._createDaySetupInputGroup = function () {
    ...
    for (var i = 0; i < config.length; i++) {
      ...
      html += '   <label class="col-sm-2 control-label">'+ val.name +'</label><div class="col-sm-3">';
  ...
  fn.handleClickEvent = function () {
    ...
    // 保存设置
    this.settingWindow.on('click', '.btn-primary', function () {
